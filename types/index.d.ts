import VtsStatic from '../src/static';
import { VtsField } from './config/index';
import VtsConfig from './config/index';
import AjaxSettings from './config/AjaxSettings';
import { Rules, ValidationMessages } from './config/rules';
import { ValidationResults } from './instance';
...
declare class Vts extends VtsStatic {
   ...
   */
  renderFeedback: (this: VtsField, messages: ValidationResults, renderClass: string) => void;
  ...
  static getResponseMessage(
    ...
    defaultResponseMessages?: string[],
