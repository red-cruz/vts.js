...
export default interface AjaxSettings {
   ...
   */
  complete: (errorData: any, response: Response | null, form: HTMLFormElement) => void;
   ...
   * @param form The HTML form element that was submitted.
   */
  error: (errorData: any, response: Response | null, form: HTMLFormElement) => void | Promise<void>;
   ...
   * @param form The HTML form element that was submitted.
   */
  success: (data: any, response: Response, form: HTMLFormElement) => void | Promise<void>;
}
