...
var vtsEvents = {
  _addEventListeners: function _addEventListeners() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // this.#log.start();
      _this._validate();
      _this.form.classList.add(_this.config.validatedClass);
      if (_this.isFormValid() && !_this.config.halt) {
        _this.submit();
      }
    });
    ...
    this.fields.forEach(function (field) {
      var rules = _this._getFieldRules(field.name);
      var match = rules === null || rules === void 0 ? void 0 : rules.match;
      var eventType = _this._getEventType(field.type, rules === null || rules === void 0 ? void 0 : rules.eventType);
  ...
  _attachMatchEvents: function _attachMatchEvents() {
    var _this2 = this;
    var _iterator = _createForOfIteratorHelper(this.config.rules.entries()),
      _step;
    try {
      var _loop = function _loop() {
        ...
        if (match) {
          ...
          var matchField = form.querySelector("[name=\"".concat(match, "\"]"));
...
var vtsRules = {
  _applyRules: function _applyRules(rules, fieldValue, fieldData) {
    var valid = false;
    var regExp = new RegExp(rules.pattern, rules.flags);
    if (regExp.test(fieldValue)) {
      var _rules$message;
      fieldData.message = (_rules$message = rules.message) === null || _rules$message === void 0 ? void 0 : _rules$message.valid;
      valid = true;
    } else {
      var _rules$message2;
      fieldData.message = (_rules$message2 = rules.message) === null || _rules$message2 === void 0 ? void 0 : _rules$message2.invalid;
    }
    return [valid, fieldData];
  },
  _applyMatch: function _applyMatch(rules, fieldValue, fieldData) {
    var _fieldData$message;
    var valid = false;
    var matchingField = this.form.querySelector("[name=\"".concat(rules.match, "\"]"));
    var matchValue = matchingField.value;
    var regExp = new RegExp("^".concat(matchValue, "$"), rules.flags);
    if (regExp.test(fieldValue)) {
      var _rules$message3;
      fieldData.message = (_rules$message3 = rules.message) === null || _rules$message3 === void 0 ? void 0 : _rules$message3.valid;
      valid = true;
    } else {
      var _rules$message4;
      fieldData.message = (_rules$message4 = rules.message) === null || _rules$message4 === void 0 ? void 0 : _rules$message4.invalid;
    }
    fieldData.message = (_fieldData$message = fieldData.message) === null || _fieldData$message === void 0 ? void 0 : _fieldData$message.replaceAll('${targetValue}', matchValue).replaceAll('${targetLabel}', getFieldLabel(matchingField, this.form));
    return [valid, fieldData];
  },
...
function Validation_slicedToArray(arr, i) { return Validation_arrayWithHoles(arr) || Validation_iterableToArrayLimit(arr, i) || Validation_unsupportedIterableToArray(arr, i) || Validation_nonIterableRest(); }
function Validation_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function Validation_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i["return"] && (_r = _i["return"](), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
...
var vtsValidation = {
  ...
  _validate: function _validate() {
    ...
    var _iterator = Validation_createForOfIteratorHelper(this.fields),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
  ...
  _checkFieldValidity: function _checkFieldValidity(field) {
    ...
    if (rules) {
      ...
      if (valid) {
        ...
        var _updatedData = updatedData;
        var _updatedData2 = Validation_slicedToArray(_updatedData, 2);
        valid = _updatedData2[0];
        fieldData = _updatedData2[1];
      }
    }
    fieldData.message = (_fieldData$message = fieldData.message) === null || _fieldData$message === void 0 ? void 0 : _fieldData$message.replaceAll('${value}', field.value).replaceAll('${label}', fieldData.label);
  ...
  _reportValidity: function _reportValidity() {
    ...
    var form = this.form;
    var fnValid = this.config.fnValid;
    var fnInvalid = this.config.fnInvalid;
    fnValid(validData, form);
    fnInvalid(invalidData, form);
  },
  _setValidity: function _setValidity(valid, field, data) {
    if (valid) {
      this._clearValidity(field);
  ...
  _clearValidity: function _clearValidity(field) {
...
var vtsDefaults = {
  ...
  ajax: {
    ...
    error: function error(_error, raw) {
      console.table(raw);
      alert(_error || raw);
    },
  ...
  fnInvalid: function fnInvalid(currentField, label, title, message) {
    currentField.focus();
  ...
  rules: {},
  fnValid: function fnValid(currentField) {
    currentField.style.border = '1px solid green';
  }
};

;// CONCATENATED MODULE: ./src/utils/setVtsConfig.js
function setVtsConfig_typeof(obj) { "@babel/helpers - typeof"; return setVtsConfig_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, setVtsConfig_typeof(obj); }
...
function _defineProperty(obj, key, value) { key = setVtsConfig_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function setVtsConfig_toPropertyKey(arg) { var key = setVtsConfig_toPrimitive(arg, "string"); return setVtsConfig_typeof(key) === "symbol" ? key : String(key); }
function setVtsConfig_toPrimitive(input, hint) { if (setVtsConfig_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (setVtsConfig_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
// @ts-check
 ...
 * @returns {*}
 */
function setVtsConfig(form, config, abortController) {
  var options = lodash_default().merge({}, vtsDefaults, config);
  config.rules = {
    first_name: {
      pattern: 'test',
      message: {
  ...
  var rawRequest = lodash_default().merge({
    request: {
      'Content-Type': 'multipart/form-data'
    }
  }, ajax.request);
  var signal = abortController.signal;
  options.ajax.request = _objectSpread(_objectSpread({}, rawRequest), {}, {
    signal: signal
  });
  return options;
}
...
var vtsForm = {
  ...
  submit: function submit() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var form, ajax, request, response, contentType, _yield$Promise$all, _yield$Promise$all2, data, rawResponse, errorData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 3;
            ajax.beforeSend(_this.abortController, form);
            _context.next = 7;
            return fetch(ajax.action, request);
          case 7:
          ...
          case 34:
            ...
            ajax.error(_context.t1, _context.t0, form);
          case 37:
            _context.next = 40;
            break;
          case 39:
            ajax.error(null, _context.t0, form);
          case 40:
            ajax.complete(form);
          case 41:
          case "end":
...
var _mixin = /*#__PURE__*/new WeakSet();
var ValidateThenSubmit = /*#__PURE__*/function () {
  function ValidateThenSubmit(formId) {
    ...
    _classPrivateMethodInitSpec(this, _mixin);
    _classPrivateMethodInitSpec(this, _init);
    var _form = VtsFormValidator.validateForm(formId);
    var abortController = this.abortController = new AbortController();
    this.config = setVtsConfig(_form, config, abortController);
  ...
  ValidateThenSubmit_createClass(ValidateThenSubmit, null, [{
    ...
    value: function setDefaults(config) {
      lodash_default().merge(vtsDefaults, config);
    }
  }]);
  return ValidateThenSubmit;
}();
function _init2() {
  _classPrivateMethodGet(this, _mixin, _mixin2).call(this);
  var form = this.form;
