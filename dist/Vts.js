...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Vts'] = factory();
  else root['Vts'] = factory();
})(self, () => {
  return /******/ (() => {
    // webpackBootstrap
    /******/ 'use strict';
    /******/ var __webpack_modules__ = {
      /***/ 186: /***/ (
        ...
        var whatwg_fetch_fetch = __webpack_require__(147); // CONCATENATED MODULE: ./src/utils/getResponseData.js
        ...
        function _getResponseData() {
          _getResponseData = _asyncToGenerator(
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        throw new Error(
                          'Content-Type header not found in the response'
                        );
                      case 4:
                        data = null;
        ...
        function Form_regeneratorRuntime() {
          'use strict';
          /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ Form_regeneratorRuntime =
            function _regeneratorRuntime() {
              return exports;
            };
          var exports = {},
        ...
        function Form_asyncGeneratorStep(
          gen,
          resolve,
          reject,
          _next,
        ...
        var vtsForm = {
          ...
          submit: function submit() {
            var _this = this;
            return Form_asyncToGenerator(
              /*#__PURE__*/ Form_regeneratorRuntime().mark(function _callee() {
                var data,
                  response,
                  promiseResolved,
                  ajax,
                  form,
                  _this$ajax$request$si;
                return Form_regeneratorRuntime().wrap(
                  function _callee$(_context) {
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          _context.next = 7;
                          return fetch(
                            new Request(_this.ajax.action, _this.ajax.request)
                          );
                        case 7:
                        ...
                        case 16:
                          ...
                          if (
                            (_this$ajax$request$si =
                              _this.ajax.request.signal) !== null &&
                            _this$ajax$request$si !== void 0 &&
                            _this$ajax$request$si.aborted
                          ) {
                            // @ts-ignore
        ...
        /* harmony default export */ const Form = vtsForm; // CONCATENATED MODULE: ./src/utils/VtsFormValidator.js
        function VtsFormValidator_typeof(obj) {
          '@babel/helpers - typeof';
          return (
            (VtsFormValidator_typeof =
              'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                ? function (obj) {
                    return typeof obj;
                  }
        ...
        function _toPropertyKey(arg) {
          ...
          return VtsFormValidator_typeof(key) === 'symbol' ? key : String(key);
        }
        function _toPrimitive(input, hint) {
          if (VtsFormValidator_typeof(input) !== 'object' || input === null)
            return input;
          var prim = input[Symbol.toPrimitive];
          if (prim !== undefined) {
            var res = prim.call(input, hint || 'default');
            if (VtsFormValidator_typeof(res) !== 'object') return res;
              ...
              value:
                ...
                function validateForm(form) {
                  ...
                  if (typeof form === 'string') {
                    ...
                    if (!_form) {
                      throw new TypeError(
                        'The form element with ID "'.concat(
                          form,
                          '" was not found.'
                        )
                      );
        ...
        function checkHTMLFormInstance(element) {
          if (!(element instanceof HTMLFormElement)) {
            ...
            throw new TypeError(
              'The element '.concat(msg, ' is not a valid HTML form element.')
            );
          }
          return element;
        ...
        function Events_slicedToArray(arr, i) {
          return (
            Events_arrayWithHoles(arr) ||
            Events_iterableToArrayLimit(arr, i) ||
            Events_unsupportedIterableToArray(arr, i) ||
            Events_nonIterableRest()
          );
        }
        ...
        function Events_createForOfIteratorHelper(o, allowArrayLike) {
          var it =
            (typeof Symbol !== 'undefined' && o[Symbol.iterator]) ||
            o['@@iterator'];
          if (!it) {
            if (
              Array.isArray(o) ||
              (it = Events_unsupportedIterableToArray(o)) ||
              (allowArrayLike && o && typeof o.length === 'number')
            ) {
              if (it) o = it;
              var i = 0;
        ...
        function Events_asyncGeneratorStep(
          gen,
          resolve,
          reject,
          _next,
        ...
        var vtsEvents = {
          _addEventListeners: function _addEventListeners() {
            ...
            form.addEventListener(
              'submit',
              /*#__PURE__*/ (function () {
                var _ref = Events_asyncToGenerator(
                  /*#__PURE__*/ Events_regeneratorRuntime().mark(
                    function _callee(e) {
                      var formClass,
                        wasValidated,
                        shouldListen,
                        ...
                        _step,
                        field;
                      return Events_regeneratorRuntime().wrap(
                        function _callee$(_context) {
                          while (1)
                            switch ((_context.prev = _context.next)) {
                              case 0:
                                ...
                                formClass =
                                  _this['class'].form || 'was-validated';
                                wasValidated =
                                  form.classList.contains(formClass);
                                ...
                                // validate each field
                                _iterator = Events_createForOfIteratorHelper(
                                  _this.fields
                                );
                                _context.prev = 8;
                                _iterator.s();
                              case 10:
                                ...
                                field = _step.value;
                                _context.next = 14;
                                return _this._checkFieldValidity(field);
                              case 14:
                                _context.next = 10;
                                break;
                              case 16:
          ...
          _addFieldListener: function _addFieldListener() {
            ...
            if (this.fields)
              this.fields.forEach(function (field) {
                ...
                var eventType = _this2._getEventType(
                  field.type,
                  rules === null || rules === void 0 ? void 0 : rules.eventType
                );
          ...
          _attachMatchEvents: function _attachMatchEvents() {
            ...
            if (
              Events_typeof(ruleEntries) === 'object' &&
              ruleEntries instanceof Map
            ) {
              var _iterator2 = Events_createForOfIteratorHelper(
                  ruleEntries.entries()
                ),
                _step2;
              try {
                var _loop = function _loop() {
                  ...
                  var eventType = _this3._getEventType(
                    field.type,
                  ...
                  if (match) {
                    var matchField = VtsFormValidator.validateField(
                      form,
                      match
                    );
                    if (!matchField) return 'continue';
                  ...
                  if (dependent) {
                    var neededField = VtsFormValidator.validateField(
                      form,
                      dependent
                    );
                    if (!neededField) return 'continue';
          ...
          _getEventType: function _getEventType(fieldType, ruleEventType) {
            ...
            var eventType = changeEvents.includes(fieldType)
              ? 'change'
              : 'input';
        ...
        /* harmony default export */ const Events = vtsEvents; // CONCATENATED MODULE: ./src/utils/getFieldLabel.js
        /**
        ...
        function getFieldLabel(field, form) {
          ...
          var labelElement = form.querySelector(
            'label[for="'.concat(field.id, '"]')
          );
          var labelText =
            labelElement === null || labelElement === void 0
              ? void 0
        ...
        function Rules_regeneratorRuntime() {
          'use strict';
          /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ Rules_regeneratorRuntime =
            function _regeneratorRuntime() {
              return exports;
            };
          var exports = {},
        ...
        function Rules_asyncGeneratorStep(
          gen,
          resolve,
          reject,
          _next,
        ...
        function Rules_asyncToGenerator(fn) {
          return function () {
            var self = this,
              args = arguments;
            return new Promise(function (resolve, reject) {
        ...
        var vtsRules = {
          _applyRules: function _applyRules(rules, field, label) {
            var _this = this;
            return Rules_asyncToGenerator(
              /*#__PURE__*/ Rules_regeneratorRuntime().mark(function _callee() {
                var _rules$flags;
                var message,
                  pattern,
                  matches,
                  ...
                  regExp,
                  _ref,
                  _rules$message$valid,
                  _rules$message2,
                  _rules$message3,
                  _message;
                return Rules_regeneratorRuntime().wrap(function _callee$(
                  _context
                ) {
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        message = _this.message.invalid || 'Invalid field';
                        pattern =
                          ('pattern' in rules ? rules.pattern : '') || '';
                        matches =
                          'matches' in rules && !('pattern' in rules)
                            ? rules.matches
                            : false;
                        matchValue = ''; // overwrite pattern
                        pattern =
                          (_rules$flags = rules.flags) !== null &&
                          _rules$flags !== void 0 &&
                          _rules$flags.includes('g')
                            ? pattern + '\\b'
                            : pattern;
                        if (!matches) {
                          _context.next = 12;
                        ...
                        matchingField = VtsFormValidator.validateField(
                          _this.form,
                          matches
                        );
                        if (matchingField) {
                      ...
                      case 10:
                        ...
                        // overwrite pattern
                        pattern =
                          (_rules$flags2 = rules.flags) !== null &&
                          _rules$flags2 !== void 0 &&
                          _rules$flags2.includes('g')
                            ? matchValue + '\\b'
                            : '^'.concat(matchValue, '$');
                      case 12:
                        dependent = rules.requires;
                        neededField = null;
                        if (!dependent) {
                          _context.next = 21;
                          break;
                        }
                        neededField = VtsFormValidator.validateField(
                          _this.form,
                          dependent
                        );
                        if (neededField) {
                      ...
                      case 21:
                        ...
                        loadingMsg = (
                          ((_rules$message = rules.message) === null ||
                          _rules$message === void 0
                            ? void 0
                            : _rules$message.loading) || _this.message.loading
                        )
                          .replace(/\${value}/g, field.value)
                          .replace(/\${label}/g, _label);
                        field.setCustomValidity(loadingMsg);
                        _this._setValidityData(field, {
                          field: field,
                          label: _label,
                          message: loadingMsg,
                        });
                      ...
                      case 35:
                        ...
                        if (
                          (neededField || regExp.test(field.value)) &&
                          validator === ''
                        ) {
                          message =
                            (_ref =
                              (_rules$message$valid =
                                (_rules$message2 = rules.message) === null ||
                                _rules$message2 === void 0
                                  ? void 0
                                  : _rules$message2.valid) !== null &&
                              _rules$message$valid !== void 0
                                ? _rules$message$valid
                                : _this.message.valid) !== null &&
                            _ref !== void 0
                              ? _ref
                              : '';
                          ...
                          message =
                            validator ||
                            ((_rules$message3 = rules.message) === null ||
                            _rules$message3 === void 0
                              ? void 0
                              : _rules$message3.invalid) ||
                            message;
                        ...
                        if (matches && matchingField) {
                          message =
                            (_message = message) === null || _message === void 0
                              ? void 0
                              : _message
                                  .replace(/\${targetValue}/g, matchValue)
                                  .replace(
                                    /\${targetLabel}/g,
                                    getFieldLabel(matchingField, _this.form)
                                  );
                        }
        ...
        function warnMultiRule(rules, label) {
          if ('pattern' in rules && 'matches' in rules) {
            console.warn(
              'Both "pattern" and "matches" properties exist in the field rule for '.concat(
                label,
                '. '
        ...
        function Validation_typeof(obj) {
          '@babel/helpers - typeof';
          return (
            (Validation_typeof =
              'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
            ...
            Validation_typeof(obj)
          );
        }
        function Validation_regeneratorRuntime() {
          'use strict';
          /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ Validation_regeneratorRuntime =
            function _regeneratorRuntime() {
              return exports;
            };
          var exports = {},
            ...
            function invoke(method, arg, resolve, reject) {
              ...
              if ('throw' !== record.type) {
                var result = record.arg,
                  value = result.value;
                return value &&
                  'object' == Validation_typeof(value) &&
                  hasOwn.call(value, '__await')
                  ? PromiseImpl.resolve(value.__await).then(
                      function (value) {
                        invoke('next', value, resolve, reject);
        ...
        function Validation_asyncGeneratorStep(
          gen,
          resolve,
          reject,
          _next,
        ...
        function Validation_asyncToGenerator(fn) {
          return function () {
            var self = this,
              args = arguments;
            return new Promise(function (resolve, reject) {
        ...
        var vtsValidation = {
          ...
          _checkFieldValidity: function _checkFieldValidity(field) {
            var _this = this;
            return Validation_asyncToGenerator(
              /*#__PURE__*/ Validation_regeneratorRuntime().mark(
                function _callee() {
                  var label, message, fieldData;
                  return Validation_regeneratorRuntime().wrap(function _callee$(
                    _context
                  ) {
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          field.setCustomValidity('');
                          label = getFieldLabel(field, _this.form);
                          _context.next = 4;
                          return _this._validate(field, label);
                        case 4:
                          ...
                          _this._setValidityData(field, fieldData);
                          _this._reportValidity();
                        case 8:
                        case 'end':
                          return _context.stop();
              ...
              /*#__PURE__*/ Validation_regeneratorRuntime().mark(
                function _callee2() {
                  ...
                  var message,
                    ...
                    ruleMsg,
                    custMsg;
                  return Validation_regeneratorRuntime().wrap(
                    function _callee2$(_context2) {
                      while (1)
                        switch ((_context2.prev = _context2.next)) {
                          ...
                          case 4:
                            rules = _this2._getFieldRules(fieldName);
                            validity = field.validity;
                            _context2.t0 =
                              Validation_regeneratorRuntime().keys(validity);
                          case 7:
                            ...
                            messageConfig = _this2.message; // field specific rule message
                            ruleMsg =
                              rules !== null &&
                              rules !== void 0 &&
                              rules.message
                            ...
                            _context2.next = 17;
                            return _this2._applyRules(rules, field, label);
                          case 17:
        ...
        /* harmony default export */ const Validation = vtsValidation; // CONCATENATED MODULE: ./src/utils/constants.js
        // @ts-check
        ...
        var vtsResponseMessages = {
          ...
          500: {
            ...
            message:
              "An unexpected error occurred on the server. We're working on it and will fix it as soon as possible.",
          },
          503: {
        ...
        function getResponseMessage_typeof(obj) {
          '@babel/helpers - typeof';
          return (
            (getResponseMessage_typeof =
              'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                ? function (obj) {
                    return typeof obj;
                  }
            ...
            getResponseMessage_typeof(obj)
          );
        }
        function getResponseMessage_slicedToArray(arr, i) {
          return (
            getResponseMessage_arrayWithHoles(arr) ||
            getResponseMessage_iterableToArrayLimit(arr, i) ||
            getResponseMessage_unsupportedIterableToArray(arr, i) ||
            getResponseMessage_nonIterableRest()
          );
        }
        function getResponseMessage_nonIterableRest() {
          throw new TypeError(
            'Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.'
          );
        }
        function getResponseMessage_unsupportedIterableToArray(o, minLen) {
          if (!o) return;
          if (typeof o === 'string')
            return getResponseMessage_arrayLikeToArray(o, minLen);
          var n = Object.prototype.toString.call(o).slice(8, -1);
          if (n === 'Object' && o.constructor) n = o.constructor.name;
          if (n === 'Map' || n === 'Set') return Array.from(o);
          if (
        ...
        function getResponseMessage_arrayLikeToArray(arr, len) {
          if (len == null || len > arr.length) len = arr.length;
          for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
          return arr2;
        }
        function getResponseMessage_iterableToArrayLimit(arr, i) {
          var _i =
            null == arr
              ? null
              : ('undefined' != typeof Symbol && arr[Symbol.iterator]) ||
        ...
        function getResponseMessage_arrayWithHoles(arr) {
          if (Array.isArray(arr)) return arr;
        }
        // @ts-check
        ...
        function getResponseMessage_getResponseMessage(data, response) {
          ...
          if (response) {
            ...
            var _getDefaultMsgFromRes = getDefaultMsgFromResponse(
              response,
              defaultResponseMessages
            );
            var _getDefaultMsgFromRes2 = getResponseMessage_slicedToArray(
              _getDefaultMsgFromRes,
              2
            );
        ...
        function showDialog(title, message) {
          ...
          if (existingDialog instanceof HTMLDialogElement) {
            ...
            var messageSection = existingDialog.querySelector(
              '#'.concat(dialogMsgId)
            );
            if (messageSection instanceof HTMLDivElement) {
              var titleBar = existingDialog.querySelector(
                '#'.concat(dialogTitleId)
              );
        ...
        var ajaxHandler = {
          ...
          beforeSend: function beforeSend(requestInit, abortController, form) {
            ...
            var vtsSessionId = '__Vts_'.concat(
            ...
            if (
              ...
              (_submitBtn$parentElem = submitBtn.parentElement) === null ||
              _submitBtn$parentElem === void 0
                ? void 0
                : _submitBtn$parentElem.append(cancelBtn);
            }
          ...
          complete: function complete(data, response, form) {
            ...
            if (cancelBtn) {
              ...
              var submitBtnDisplay =
                window.sessionStorage.getItem(vtsSessionId);
              if (submitBtnDisplay) {
          ...
          error: function error(errorData, errorResponse, form) {
            var _getResponseMessage = getResponseMessage_getResponseMessage(
                errorData,
                errorResponse
              ),
          ...
          success: function success(data, response, form) {
            var _getResponseMessage2 = getResponseMessage_getResponseMessage(
                data,
                response
              ),
        ...
        /* harmony default export */ const ajax = ajaxHandler; // CONCATENATED MODULE: ./src/defaults/handler.js
        // @ts-check
          ...
          var _loop = function _loop() {
            ...
            var sibling =
              parent === null || parent === void 0
                ? void 0
                : parent.querySelector('.'.concat(renderClass));
            ...
            var validSib =
              parent === null || parent === void 0
                ? void 0
                : parent.querySelector('.valid-feedback');
            var invalidSib =
              parent === null || parent === void 0
                ? void 0
        ...
        /* harmony default export */ const handler = vtsHandlers; // CONCATENATED MODULE: ./src/defaults/index.js
        // @ts-check
        ...
        /* harmony default export */ const defaults = vtsDefaults; // CONCATENATED MODULE: ./src/utils/deepMerge.js
        function deepMerge_typeof(obj) {
          '@babel/helpers - typeof';
          return (
            (deepMerge_typeof =
              'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
        ...
        function deepMerge(target) {
          ...
          for (var key in source) {
            if (
              deepMerge_typeof(source[key]) === 'object' &&
              source[key] !== null &&
              !Array.isArray(source[key])
            ) {
              if (
                !target[key] ||
                deepMerge_typeof(target[key]) !== 'object' ||
        ...
        function setVtsConfig(form, config) {
          ...
          options.ajax.action =
            ajax.action || form.getAttribute('action') || '';
        ...
        function vts_regeneratorRuntime() {
          'use strict';
          /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ vts_regeneratorRuntime =
            function _regeneratorRuntime() {
              return exports;
            };
          var exports = {},
        ...
        function vts_asyncGeneratorStep(
          gen,
          resolve,
          reject,
          _next,
        ...
        function vts_asyncToGenerator(fn) {
          return function () {
            var self = this,
              args = arguments;
            return new Promise(function (resolve, reject) {
        ...
        function vts_classCallCheck(instance, Constructor) {
          if (!(instance instanceof Constructor)) {
            throw new TypeError('Cannot call a class as a function');
          }
        }
        function vts_defineProperties(target, props) {
          for (var i = 0; i < props.length; i++) {
            var descriptor = props[i];
            descriptor.enumerable = descriptor.enumerable || false;
            descriptor.configurable = true;
            ...
            Object.defineProperty(
              target,
              vts_toPropertyKey(descriptor.key),
              descriptor
            );
          }
        }
        function vts_createClass(Constructor, protoProps, staticProps) {
          if (protoProps)
            vts_defineProperties(Constructor.prototype, protoProps);
          if (staticProps) vts_defineProperties(Constructor, staticProps);
          Object.defineProperty(Constructor, 'prototype', { writable: false });
          return Constructor;
        }
        function vts_toPropertyKey(arg) {
          var key = vts_toPrimitive(arg, 'string');
          return vts_typeof(key) === 'symbol' ? key : String(key);
        }
        function vts_toPrimitive(input, hint) {
          if (vts_typeof(input) !== 'object' || input === null) return input;
          var prim = input[Symbol.toPrimitive];
          if (prim !== undefined) {
            var res = prim.call(input, hint || 'default');
            if (vts_typeof(res) !== 'object') return res;
            throw new TypeError('@@toPrimitive must return a primitive value.');
          }
          return (hint === 'string' ? String : Number)(input);
        }
        ...
        var Vts = /*#__PURE__*/ (function () {
          ...
          function Vts(_form) {
            ...
            this.fields = elem.querySelectorAll(
              '[name]:not([data-vts-ignored])'
            );
            // @ts-ignore
            _classPrivateMethodGet(this, _init, _init2).call(
              this,
              elem,
              _config
            );
          ...
          vts_createClass(Vts, null, [
              ...
              value: function getOrCreateInstance(formId) {
                var config =
                  arguments.length > 1 && arguments[1] !== undefined
                    ? arguments[1]
                    : {};
                var hasInstance = _classStaticPrivateFieldSpecGet(
                  Vts,
                  Vts,
                  _instances
                ).get(formId);
            ...
            },
            {
              ...
              value: function removeInstance(formId) {
                return _classStaticPrivateFieldSpecGet(Vts, Vts, _instances)[
                  'delete'
                ](formId);
              },
            ...
            },
            {
              key: 'getResponseData',
              value: (function () {
                var _getResponseData = vts_asyncToGenerator(
                  /*#__PURE__*/ vts_regeneratorRuntime().mark(function _callee(
                    response
                  ) {
                    return vts_regeneratorRuntime().wrap(function _callee$(
                      _context
                    ) {
                      while (1)
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            return _context.abrupt(
                              'return',
                              getResponseData_getResponseData(response)
                            );
                          case 1:
                          case 'end':
                            return _context.stop();
            ...
            },
            {
              ...
              value: function getResponseMessage(
                ...
                return getResponseMessage_getResponseMessage(
                  data,
                  response,
                  defaultResponseMessages
                );
        ...
        function _init2(form, config) {
          ...
          var id =
            formId ||
            'Vts_form_' +
              _classStaticPrivateFieldSpecGet(Vts, Vts, _instances).size;
          // @ts-ignore
